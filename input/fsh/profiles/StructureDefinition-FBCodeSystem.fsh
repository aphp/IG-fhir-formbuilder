Profile: FBCodeSystem
Parent: CodeSystem
Title: "AP-HP FormBuilder CodeSystem"
Description: "Profil de CodeSystem pour la pleine utilisation du FormBuilder (et de ses fonctionalités terminologiques)"
