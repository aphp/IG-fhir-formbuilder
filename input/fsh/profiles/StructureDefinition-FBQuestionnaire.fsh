Profile: FBQuestionnaire
Parent: Questionnaire
Title: "AP-HP FormBuilder Questionnaire"
Description: "Profil de Questionnaire pour la pleine utilisation du FormBuilder (et de ses fonctionalités terminologiques)"
...
* item.extension contains
    QuestionnaireItemSource named QuestionnaireItemSource 0..1
